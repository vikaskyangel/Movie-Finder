...
class MovieTabRecyclerAdapter(
    var movieList: List<Movie> = emptyList(),
    var itemClick: (Movie) -> Unit
) :
    RecyclerView.Adapter<MovieTabRecyclerAdapter.MovieViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val v: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_tab_movie, parent, false)
